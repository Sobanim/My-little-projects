...
if __name__ == "__main__":
    ...
    #                             [0, 0, 2, 1]])
    #
    # training_outputs = np.array([[0.6, 0.3, 0, 1, 0, 0.6, 0, 0.6, 1, 0.6, 0, 1, 0, 0, 0.6, 0.6, 0.6, 0.6, 0.6, 0.3, 0, 0.6, 0.6, 0.3, 0.3, 0.3, 0.3, 0.6, 0, 1, 0, 0.6, 1, 0.6, 0.6]]).T
    # Training inputs for neural network
    ...
    for i in range(10000):
        ...
        maximalneIndex = xxx.index(max(xxx))
        maximalne = 0
        if maximalneIndex == 0:
            maximalne = 0.0
        elif maximalneIndex == 1:
            maximalne = 0.3
        elif maximalneIndex == 2:
            maximalne = 0.6
        elif maximalneIndex == 3:
            maximalne = 1.0
        #tempList.append(maximalne)
        training_outputs.append(maximalne)

    tempList = []
    tempList.append(training_outputs)

    # training taking place
    neural_network.train(np.array(training_inputs), np.array(tempList).T, 10000)
